...
# To use this script, create a tab-delimited text file called "create_ao_folder.txt" and save it in the same directory from which you are running this script
...
with open('create_ao_folder.txt', 'r') as file:
